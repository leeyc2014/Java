...
public class Test04_실습대상 {
	...
	public static void b() throws Exception { // throws가 있으면 반드시 try catch문으로 구현
		try {
			c();
			c();
	...
	public static void main(String[] args) {
		/*
			FileInputStream fi = new FileInputStream("a.txt");//에러 발생 이유 - FileInputStream 클래스는 예외처리 필수(try catch문)
			int c = fi.read();
